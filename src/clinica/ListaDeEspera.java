...
public class ListaDeEspera {
	...
	public Paciente atender() throws IndexOutOfBoundsException {
...
//		return this.listaDePacientes.remove(0); //así se puede hacer todo en la misma linea
	...
	public void colar(Paciente paciente, int posicion) throws IndexOutOfBoundsException {
	...
	public boolean isEmpty() {
		return listaDePacientes.isEmpty();
	}
